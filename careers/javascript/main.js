...
;(function($) {
   ...
   'use strict'
    ...
    var googleMap = function() {
        ...
        // Gmap Defaults
        if ( $().gmap3 ){
                var data = JSON.parse('[{"address":"Kokrajhar,  Assam, India","content":""}]');
                var data2 = JSON.parse('[{"address":"Kokrajhar, Assam, India","content":""}]');
            $('.maps').gmap3({
                map:{
                    options:{
                                ...
                                mouseover: function() {
                                    $(this).gmap3({
                                        overlay:{
                                            address:val.address,
                                            options:{
                                                content:  "<div class='infobox clearfix'><div class='img-map float-left'><img src='images/maps/f1.jpg' alt='image'></div><div class='info-map'><h5>Kokrajhar Town,<br> Assam, India</h5></div><div class='clearfix'></div></div>",
                                                offset:{
                                                    y:34,
                                                    x:-186
                                                }
